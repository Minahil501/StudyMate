...
`uploads/sample.pdf` and hitting a live model API as a side effect of
...
runs without a real Hugging Face access token.

To run one of these manually (requires a `HUGGINGFACEHUB_API_TOKEN` set,
